...
> ListTransactionApprovalDetails200Response listTransactionApprovalDetails(transactionId, coboIds)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListTransactionApprovalDetails200Response result = apiInstance.listTransactionApprovalDetails(transactionId, coboIds);
      System.out.println(result);
    } catch (ApiException e) {
