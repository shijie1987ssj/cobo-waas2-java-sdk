...
public class CreateUnstakeActivity {
  ...
  **/
  ...
  public CreateUnstakeActivity amount(String amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public CreateUnstakeActivity fee(TransactionRequestFee fee) {
    this.fee = fee;
    return this;
  }
  ...
  **/
  ...
  public CreateUnstakeActivity extra(CreateUnstakeActivityExtra extra) {
    this.extra = extra;
    return this;
  }
  ...
  **/
   ...
   * @return the CreateUnstakeActivity instance itself
   */
  public CreateUnstakeActivity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requestId, createUnstakeActivity.requestId) &&
        ...
        Objects.equals(this.extra, createUnstakeActivity.extra)&&
        Objects.equals(this.additionalProperties, createUnstakeActivity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requestId, stakingId, amount, fee, extra, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateUnstakeActivity
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUnstakeActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUnstakeActivity is not found in the empty JSON string", CreateUnstakeActivity.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUnstakeActivity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUnstakeActivity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUnstakeActivity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUnstakeActivity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUnstakeActivity.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUnstakeActivity>() {
           @Override
           public void write(JsonWriter out, CreateUnstakeActivity value) throws IOException {
           ...
           @Override
           public CreateUnstakeActivity read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateUnstakeActivity instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateUnstakeActivity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateUnstakeActivity
  * @throws IOException if the JSON string is invalid with respect to CreateUnstakeActivity
  */
  public static CreateUnstakeActivity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUnstakeActivity.class);
  }

 /**
  * Convert an instance of CreateUnstakeActivity to an JSON string
  *
  * @return JSON string
  */
