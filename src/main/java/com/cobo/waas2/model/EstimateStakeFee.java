...
public class EstimateStakeFee {
  ...
  public EstimateStakeFee() {
  }

  public EstimateStakeFee activityType(ActivityType activityType) {
  ...
  **/
  ...
  public EstimateStakeFee source(StakingSource source) {
    this.source = source;
    return this;
  }
  ...
  **/
  ...
  public EstimateStakeFee amount(String amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public EstimateStakeFee fee(TransactionRequestFee fee) {
    this.fee = fee;
    return this;
  }
  ...
  **/
  ...
  public EstimateStakeFee extra(CreateStakeActivityExtra extra) {
    this.extra = extra;
    return this;
  }
  ...
  **/
   ...
   * @return the EstimateStakeFee instance itself
   */
  public EstimateStakeFee putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activityType, estimateStakeFee.activityType) &&
        ...
        Objects.equals(this.fee, estimateStakeFee.fee) &&
        Objects.equals(this.extra, estimateStakeFee.extra)&&
        Objects.equals(this.additionalProperties, estimateStakeFee.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EstimateStakeFee
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EstimateStakeFee.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EstimateStakeFee is not found in the empty JSON string", EstimateStakeFee.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EstimateStakeFee.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EstimateStakeFee.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EstimateStakeFee' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EstimateStakeFee> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EstimateStakeFee.class));

       return (TypeAdapter<T>) new TypeAdapter<EstimateStakeFee>() {
           @Override
           public void write(JsonWriter out, EstimateStakeFee value) throws IOException {
           ...
           @Override
           public EstimateStakeFee read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EstimateStakeFee instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EstimateStakeFee given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EstimateStakeFee
  * @throws IOException if the JSON string is invalid with respect to EstimateStakeFee
  */
  public static EstimateStakeFee fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateStakeFee.class);
  }

 /**
  * Convert an instance of EstimateStakeFee to an JSON string
  *
  * @return JSON string
  */
