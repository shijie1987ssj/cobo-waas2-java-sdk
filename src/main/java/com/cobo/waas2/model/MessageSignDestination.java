...
public class MessageSignDestination extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<MessageSignDestination>() {
                ...
                public void write(JsonWriter out, MessageSignDestination value) throws IOException {
                    ...
                    // check if the actual instance is of the type `BTCEIP191MessageSignDestination`
                    if (value.getActualInstance() instanceof BTCEIP191MessageSignDestination) {
                        JsonElement element = adapterBTCEIP191MessageSignDestination.toJsonTree((BTCEIP191MessageSignDestination)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                public MessageSignDestination read(JsonReader in) throws IOException {
                    ...
                    // deserialize BTCEIP191MessageSignDestination
                    try {
                        // validate the JSON object to see if any exception is thrown
                        BTCEIP191MessageSignDestination.validateJsonElement(jsonElement);
                        actualAdapter = adapterBTCEIP191MessageSignDestination;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'BTCEIP191MessageSignDestination'");
                    } catch (Exception e) {
                        // deserialization failed, continue
    ...
    /**
     * Get the actual instance of `BTCEIP191MessageSignDestination`. If the actual instance is not `BTCEIP191MessageSignDestination`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `BTCEIP191MessageSignDestination`
     * @throws ClassCastException if the instance is not `BTCEIP191MessageSignDestination`
     */
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with BTCEIP191MessageSignDestination
        try {
            BTCEIP191MessageSignDestination.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
