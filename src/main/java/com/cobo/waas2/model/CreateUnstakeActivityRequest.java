...
public class CreateUnstakeActivityRequest {
  ...
  public CreateUnstakeActivityRequest() {
  }

  public CreateUnstakeActivityRequest requestId(String requestId) {
  ...
  **/
  ...
  public CreateUnstakeActivityRequest stakingId(String stakingId) {
  ...
  **/
  ...
  public CreateUnstakeActivityRequest amount(String amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public CreateUnstakeActivityRequest fee(TransactionRequestFee fee) {
    this.fee = fee;
    return this;
  }
  ...
  **/
   ...
   * @return the CreateUnstakeActivityRequest instance itself
   */
  public CreateUnstakeActivityRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateUnstakeActivityRequest createUnstakeActivityRequest = (CreateUnstakeActivityRequest) o;
    return Objects.equals(this.requestId, createUnstakeActivityRequest.requestId) &&
  ...
  public String toString() {
    ...
    sb.append("class CreateUnstakeActivityRequest {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateUnstakeActivityRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUnstakeActivityRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateUnstakeActivityRequest is not found in the empty JSON string", CreateUnstakeActivityRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateUnstakeActivityRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateUnstakeActivityRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateUnstakeActivityRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateUnstakeActivityRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateUnstakeActivityRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateUnstakeActivityRequest>() {
           @Override
           public void write(JsonWriter out, CreateUnstakeActivityRequest value) throws IOException {
           ...
           @Override
           public CreateUnstakeActivityRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateUnstakeActivityRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateUnstakeActivityRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateUnstakeActivityRequest
  * @throws IOException if the JSON string is invalid with respect to CreateUnstakeActivityRequest
  */
  public static CreateUnstakeActivityRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateUnstakeActivityRequest.class);
  }

 /**
  * Convert an instance of CreateUnstakeActivityRequest to an JSON string
  *
  * @return JSON string
  */
